...
function abbreviatedAthleteName(name: string): string {
...
function PregamePanel({ api, match, onChanged }: { api: ApiClient; match: MatchListItem; onChanged: () => Promise<void> }) {
  ...
  const confirmedPlayers = [
    ...
    ...confirmedGuests.map((participant) => ({ participantKey: participant.participantKey, name: participant.name, position: participant.position, source: 'GUEST' as const }))
