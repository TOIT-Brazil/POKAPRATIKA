...
- A faixa `.next-match-date-badge` agrupa nome, dia e pilha de data em uma sequência central contínua, com ordem explícita, mês e dia da semana completos e largura exata do conteúdo limitada à viewport.
