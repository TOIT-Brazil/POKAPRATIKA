- A súmula operacional agora preserva trocas manuais e o histórico local da rotação automática durante o refresh periódico da partida em andamento; além disso, a normalização da escalação passou a redistribuir goleiros naturais entre os times quando uma recomposição deixa os dois no mesmo lado.
