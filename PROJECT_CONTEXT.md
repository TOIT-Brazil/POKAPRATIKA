...
- O card `Jogos finalizados` da home foi refinado novamente para ficar mais próximo da referência visual: contador integrado ao título, confrontos em linha única com data compacta, times nas extremidades e placar central em destaque; depois, a faixa explicativa foi removida e a lista ganhou acabamento mais verde e linhas um pouco mais compactas, preservando a identidade visual escura do dashboard.
