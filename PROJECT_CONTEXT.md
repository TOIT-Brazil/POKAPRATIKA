...
- O container do frontend passou a iniciar o Nginx com `error_log stderr warn;` no entrypoint, suprimindo logs `notice` de bootstrap que a Railway estava destacando como erro mesmo sem falha real da aplicação.
