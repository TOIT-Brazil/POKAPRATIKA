...
- O card `Jogos finalizados` da home foi refinado novamente para ficar mais próximo da referência visual: contador integrado ao título, faixa explicativa destacada e cada confronto em linha única com data compacta, times nas extremidades e placar central em destaque, preservando a paleta original escura/azulada do dashboard.
